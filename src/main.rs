...
trait FuseOperations {
	fn open (&mut self, path: *const core::ffi::c_char, fi: *mut core::ffi::c_void) -> core::ffi::c_int;
	fn read (&mut self, path: *const core::ffi::c_char, buf: *mut core::ffi::c_char, size: usize, offset: libc::off_t, fi: *mut core::ffi::c_void) -> core::ffi::c_int;
}
